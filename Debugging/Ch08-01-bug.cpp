...
// My Class: CPSC 1021
// Date: 2/12/2025
// Desc: This program allows the user to select a month and then displays how many days are in that month.  It does this by "looking up" information it has stored in arrays.
